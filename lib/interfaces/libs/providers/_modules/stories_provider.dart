...
sealed class Stories extends _$Stories {
  /// The count of stories to fetch.
  late final int _storiesCount;

  int get _halfStoriesCount => _storiesCount ~/ 2;

  @override
  FutureOr<StoriesProviderValue> build({int storiesCount = 10}) async {
  ...
  /// Post a new story. Will rebuild the [storiesProvider].
  ///
  /// May throw an [AppException].
